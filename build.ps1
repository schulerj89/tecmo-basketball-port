...
$Sources = @(
    ...
    "src\tecmo_cli_gameplay_rebound_audit.c",
    ...
    "src\asset_pack\tecmo_asset_pack_gameplay_actor_command_assignment.c",
    "src\asset_pack\tecmo_asset_pack_gameplay_shot_resolution.c",
    "src\asset_pack\tecmo_asset_pack_gameplay_rebound_audit.c",
    ...
    "src\tecmo_gameplay_cpu_opcode15_selection.c",
    ...
    "src\tecmo_gameplay_defense_interaction.c",
    ...
    "src\tecmo_gameplay_actor_command_assignment.c",
    ...
    "src\tecmo_gameplay_shooting_lab.c",
    "src\tecmo_gameplay_cpu_playbook_lab.c",
    ...
    "src\tecmo_gameplay_scene_test_pretip.c",
