...
| 98 | R1-LIVE-FOUNDATION | gameplay_behavior | R1 | backlog | - | - | 0 | pending | not_ready |
...
| 96 | R1-TIP-FIDELITY | gameplay_behavior | R1 | backlog | - | - | 0 | pending | not_ready |
...
|---|---|---|---|---|---|
| OWN-R0A-INV | R0A-INV-001 | R0A | exclusive | docs/finish-orchestration/**<br>docs/finish-tasks/**<br>tools/finish-orchestration/** | R0A-inventory |
