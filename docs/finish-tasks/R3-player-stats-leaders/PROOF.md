...
## Historical native-row visual proof (superseded)

The table below preserves the source handoff's historical pre-correction
record.  Its `build\season-native-final-proof-20260804T111900846Z\` files and
11:19 UTC timestamps were not regenerated by this current-main QA run and may
not exist in this worktree.  The original hashes remain unchanged here for
lineage only; they are superseded by the corrected current-QA evidence below.
...
The historical raw-pixel note and obsolete master baselines remain source
history only.  They are not used as current-main acceptance proof.

## Current-QA corrected native-row visual proof

The proof-only seed now uses FGA 800, 3PA 500, and FTA 500, while preserving
the existing make formulas and all runtime/ranking semantics.  With the
maximum canonical key 323, every seeded make is below its corresponding
attempt.  The two current-QA captures below were inspected at original
640x480 resolution.  The category-0 pages show readable names, teams, titles,
labels, and sub-1.000 percentages; category 0 pages 6 and 12 are continuation
layouts.  TOTAL POINTS remains byte-identical because it depends on makes, not
attempts.  No glyph fragmentation, clipping, or layout collision was visible.
...
| `build\integration-qa-r3-20260804T184202450Z\season-leaders-frames-corrected-repeat\season-leaders-results-populated.png` | `2026-08-04T19:00:01.4443955Z` | `600E13073B9D8509E7E5648E8AFA5221E7E038CB51D28C40AA952E5B4B80C1AB` |
| `build\integration-qa-r3-20260804T184202450Z\season-leaders-frames-corrected-repeat\season-leaders-results-populated-page6.png` | `2026-08-04T19:00:01.4988210Z` | `F07071A9032AB6CD6B2307ED4C007AE1995B5C8CD4E37A1F205D0890368AAE14` |
| `build\integration-qa-r3-20260804T184202450Z\season-leaders-frames-corrected-repeat\season-leaders-results-populated-page12.png` | `2026-08-04T19:00:01.5563279Z` | `9C2C058CA7EB355C48ED6533536088A641D7866B16EB57C5CF01410F1FEF4FD1` |
| `build\integration-qa-r3-20260804T184202450Z\season-leaders-frames-corrected-repeat\season-leaders-results-populated3.png` | `2026-08-04T19:00:01.6087677Z` | `794DA4AE2CC6FB0B75B1F30A4F682B565F5B16A3DBC26BD0E594ABC9763A182E` |
| `build\integration-qa-r3-20260804T184202450Z\season-leaders-frames-corrected-repeat\season-leaders-results-populated5.png` | `2026-08-04T19:00:01.6634681Z` | `74871EF3FFE4EA643CD707A95B29389EC487552AB9B4D7571F3B56A526EB96FE` |
| `build\integration-qa-r3-20260804T184202450Z\season-leaders-frames-corrected-repeat\season-leaders-results-populated6.png` | `2026-08-04T19:00:01.7149163Z` | `D2561DF4460C843B85127C1B6D4AA59DBDC0640DCF186562796BAF0FCB5F1FBD` |
