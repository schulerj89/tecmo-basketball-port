...
Other eligible shot actors may consume the current `$A790/$A9DA` latch according
to their own stream. The later `$0041` writer remains outside this binding.
