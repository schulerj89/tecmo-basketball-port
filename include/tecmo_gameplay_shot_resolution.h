...
#define TECMO_GAMEPLAY_SHOT_RESOLUTION_SOURCE_COUNT 7U
...
typedef enum TecmoGameplayShotResolutionSourceKind {
    ...
    /* The direct $B87C caller gates, selector-role toggle helper, and
       claimant remap are revision-locked as separate provenance records.
       They remain source bounds, not broad gameplay labels. */
    TECMO_GAMEPLAY_SHOT_RESOLUTION_SOURCE_CLAIMANT_SETTLEMENT_CALLER = 5,
    TECMO_GAMEPLAY_SHOT_RESOLUTION_SOURCE_CLAIMANT_SELECTOR_TOGGLE = 6,
    TECMO_GAMEPLAY_SHOT_RESOLUTION_SOURCE_CLAIMANT_REMAP_TABLE = 7
