...
/* Bank04 $BA1F consumes 44 frames loading screen $05 and running the
   selector-specific referee script before fixed $EA14 begins its 4+120 frame
   release wait. */
#define TECMO_GAMEPLAY_VIOLATION_SCRIPT_FRAMES 44U
#define TECMO_GAMEPLAY_VIOLATION_RELEASE_LEAD_IN_FRAMES \
    (TECMO_GAMEPLAY_VIOLATION_SCRIPT_FRAMES + \
     TECMO_GAMEPLAY_PRESENTATION_LEAD_IN_FRAMES)
#define TECMO_GAMEPLAY_VIOLATION_PRESENTATION_FRAMES \
