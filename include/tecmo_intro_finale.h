...
/* TFIN-1 is decoded against the exact canonical Rev1 chr/all entry. */
#define TECMO_INTRO_FINALE_CHR_BYTE_COUNT 262144ULL
#define TECMO_INTRO_FINALE_CHR_FNV1A64 0x96A64F53B240ABB4ULL
