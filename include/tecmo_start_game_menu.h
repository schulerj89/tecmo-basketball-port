...
#define TECMO_START_GAME_MENU_MUSIC_VALUE_COUNT 2U
#define TECMO_START_GAME_MENU_SPEED_VALUE_COUNT 3U
#define TECMO_START_GAME_MENU_PERIOD_VALUE_COUNT 5U
...
typedef enum TecmoStartGameMenuAction {
    ...
    TECMO_START_GAME_MENU_ACTION_ALL_STAR,
    TECMO_START_GAME_MENU_ACTION_SEASON_MANAGEMENT
