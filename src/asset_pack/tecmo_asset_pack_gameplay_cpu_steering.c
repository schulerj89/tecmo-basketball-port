...
static const uint8_t cpu_steering_anchor_a0f3_launch_sha256[8][32] = {
    ...
    {0xEAU,0x41U,0xD0U,0x5EU,0x7CU,0xFBU,0x63U,0x4CU,0xD5U,0x71U,0x51U,0x0CU,0x9CU,0x7AU,0x7BU,0x18U,0x8CU,0xDCU,0xC7U,0x57U,0xF3U,0xABU,0xB8U,0x66U,0xD2U,0xDBU,0x2DU,0xFEU,0x3AU,0x04U,0x8BU,0x37U},
    ...
    {0xBAU,0xA9U,0x13U,0xD9U,0xEDU,0xFEU,0xB3U,0x22U,0x1BU,0x62U,0x35U,0x2FU,0xA3U,0x6BU,0xD6U,0xA5U,0x11U,0x84U,0xDBU,0xD8U,0xE1U,0xDCU,0x73U,0x35U,0xC4U,0xBFU,0x01U,0x52U,0x49U,0xC6U,0x73U,0x32U}
};

/* Fixed NMI counter/call ordering and the shared `$006A` mixer used by the
   LIVE checkpoint. Validation-only: no ROM bytes enter the asset payload. */
static const uint8_t cpu_steering_anchor_fixed_rng_sha256[3][32] = {
    {0x2EU,0x76U,0x1CU,0xFEU,0xBFU,0x2DU,0x51U,0x54U,0xA8U,0xEFU,0xC5U,0x7DU,0xB8U,0xE7U,0xA2U,0x26U,0x15U,0x2BU,0xB0U,0x72U,0x67U,0x8FU,0xD9U,0x88U,0xE4U,0xF0U,0x52U,0x0BU,0xDEU,0xE5U,0x8AU,0x40U},
    {0x82U,0xA4U,0xC7U,0x31U,0xD4U,0x11U,0xA7U,0xC9U,0x98U,0x79U,0x18U,0x8CU,0x9BU,0x76U,0x3BU,0xACU,0x7EU,0xB3U,0x7AU,0xC3U,0xB7U,0xE7U,0x24U,0x48U,0x33U,0xF7U,0x85U,0xD2U,0xE9U,0xECU,0x25U,0xA9U},
    {0x25U,0x3CU,0x24U,0xDFU,0xA6U,0xA2U,0x32U,0x82U,0x1AU,0xDAU,0x81U,0xE6U,0xB8U,0x91U,0x7CU,0xFDU,0x63U,0xBEU,0x4EU,0xB5U,0xB1U,0x85U,0x7FU,0xE9U,0x31U,0xA1U,0x67U,0xBDU,0x20U,0x4AU,0xD3U,0xD7U}
};
static const uint8_t cpu_steering_anchor_fixed_rng_calls_sha256[2][32] = {
    {0x35U,0x54U,0x31U,0x78U,0xD6U,0xDFU,0x77U,0x0AU,0x72U,0xA5U,0x35U,0x68U,0x39U,0x24U,0xC0U,0xFEU,0xC0U,0x0CU,0x86U,0x95U,0x0CU,0x6FU,0xE3U,0xE1U,0x5FU,0xBBU,0xF0U,0xD6U,0xECU,0x2DU,0xBEU,0xB8U},
    {0x71U,0xC6U,0x38U,0xE4U,0xFBU,0xEEU,0xC0U,0xE1U,0xA2U,0x25U,0xA1U,0xF2U,0xC2U,0x80U,0xC2U,0x39U,0x85U,0x3AU,0xACU,0xECU,0x99U,0x6EU,0xB5U,0x54U,0x7FU,0x71U,0x63U,0xD4U,0x96U,0xCEU,0xF8U,0x04U}
};
    ...
    uint64_t prg_offset)
{
    ...
    if (!validate_fixed_lifecycle_anchor(rom, rom_size, prg_offset,
            0xCD7AU, 0xCD7FU, cpu_steering_anchor_fixed_rng_sha256[0])) return 0;
    if (!validate_fixed_lifecycle_anchor(rom, rom_size, prg_offset,
            0xCD8FU, 0xCD95U, cpu_steering_anchor_fixed_rng_sha256[1])) return 0;
    if (!validate_fixed_lifecycle_anchor(rom, rom_size, prg_offset,
            0xCD96U, 0xCDABU, cpu_steering_anchor_fixed_rng_sha256[2])) return 0;
    if (!validate_lifecycle_anchor(rom, rom_size, prg_offset, 5U,
            0xA0DDU, 0xA0DFU, 0U,
            cpu_steering_anchor_fixed_rng_calls_sha256[0])) return 0;
    if (!validate_fixed_lifecycle_anchor(rom, rom_size, prg_offset,
            0xC05DU, 0xC05FU,
            cpu_steering_anchor_fixed_rng_calls_sha256[1])) return 0;
    if (!validate_lifecycle_anchor(
        ...
        !validate_lifecycle_anchor(
            rom, rom_size, prg_offset, 5U, 0x80A9U, 0x815AU,
            0xF5998EDBU, cpu_steering_anchor_a0f3_launch_sha256[3]) ||
        !validate_lifecycle_anchor(
        ...
        !validate_lifecycle_anchor(
            rom, rom_size, prg_offset, 5U, 0xB522U, 0xB52DU,
            0xEF77B509U, cpu_steering_anchor_a0f3_launch_sha256[7]) ||
    ...
    uint64_t prg_offset)
{
    static const struct {
        ...
        {5U, 0xBD6EU}, {5U, 0xB522U}, {5U, 0xA0DDU}
    };
    uint8_t *mutated;
    size_t index;
    ...
    }
    {
        static const uint16_t fixed_anchors[] = {
            ...
            0xCD7AU, 0xCD8FU, 0xCD96U, 0xC05DU
        };
        for (index = 0U;
