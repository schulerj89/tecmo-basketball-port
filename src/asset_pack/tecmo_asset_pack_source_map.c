    ...
    const TecmoGameplayShotResolutionProvenance *p)
{
    ...
    *first = 0;
    ...
    return tecmo_asset_pack_append_text(
        ...
        "scene_finish_shot/scene_finish_jump_miss after the bounded claimant selector\","
        ...
        "\"not_wired\":\"generic/made/restart/tip/steal/foul/unproven recovery and legacy-direct/rim-debug handoffs\","
        "\"unsupported\":\"$0588/$05B6 masks, claimant-side $0359 mutation, $0478, $06DF/$06E1, $0743, $0790, $07E2, "
