    ...
    const TecmoGameplayCpuSteeringProvenance *provenance)
{
    ...
    *first = 0;
    ...
    return tecmo_asset_pack_append_text(
        ...
        "\"selection_059e_lifecycle\":{\"sole_writer\":\"$920D\",\"consumer\":\"$9248-$926F\",\"consumer_fnv1a32\":\"96DD94EF\",\"reset\":\"fixed $CC58 page clear\",\"persistence\":\"never consumer-cleared; stale until next writer; full reset only\",\"validity\":\"selected actor state $057C==7\",\"dispatch\":\"selector3 with side derived from actor slot\",\"retirement\":\"actor != $0308 and $046E==0 clears $057C\"},"
