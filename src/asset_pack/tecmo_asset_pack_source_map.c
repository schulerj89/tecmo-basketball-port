    ...
    const TecmoGameplayCpuSteeringProvenance *provenance)
{
    ...
    *first = 0;
    ...
    return tecmo_asset_pack_append_text(
        ...
        "\"a8e9_velocity_normalizer\":{\"scope\":\"pure typed raw16 helper only; LIVE input unowned\","
        ...
        "\"anchors\":[\"Bank05 $A0F3-$A158 FNV E0D639BE\",\"Bank05 $B32C-$B390 FNV D3DB4014\",\"Bank05 $BCF4-$BD68 FNV A8A390BB\",\"Bank05 $80A9-$815A FNV F5998EDB\",\"Bank05 $A15C-$A183 FNV 56696FEF\",\"Bank05 $BDF7-$BEF6 FNV 93FCF6CB\",\"Bank05 $BD6E-$BDC6 FNV 3F4FB637\"],"
