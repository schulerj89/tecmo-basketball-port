    ...
    const TecmoGameplayMovementProvenance *provenance)
{
    ...
    *first = 0;
    ...
    return tecmo_asset_pack_append_text(
        ...
        "\"cpu_target_and_shot_policy\":\"exact $842E frame, $8545 metric, ordinary $BA zero, and same-frame-aware $0478 gate; $0588 bit0 remains unowned; unsupported playback is deferred\"},"
    ...
    const TecmoGameplayCpuSteeringProvenance *provenance)
{
    ...
    *first = 0;
    ...
    return tecmo_asset_pack_append_text(
        ...
        "\"shot_request_adapter\":\"exact $842E fixed-frame, persistent $8545 metric, ordinary $BA zero, and same-frame-aware $0478 inputs; $0588 bit0 remains unowned; unsupported playback deferred/non-launch\","
