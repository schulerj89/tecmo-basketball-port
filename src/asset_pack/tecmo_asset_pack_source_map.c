    ...
    const TecmoGameplayCourtProvenance *p)
{
    ...
    *first = 0;
    ...
    return tecmo_asset_pack_append_text(
        ...
        "\"boundary\":\"strict full-court decode and production camera-positioned live viewport slicing; native framebuffer rendering clips 32/33 columns inside the 256x240 gameplay subview; excludes staged PPU prefetch/write ordering, vertical camera, TGFL ownership, and capture-derived behavior\","
    ...
    const TecmoGameplayCourtOrientationProvenance *provenance)
{
    ...
    *first = 0;
    return tecmo_asset_pack_append_text(
        ...
        "and production target selection for TGCP follow direction, world-space "
        "shot endpoints, and close-distance orientation; no TGFL ownership or "
    ...
    const TecmoGameplayCameraProvenance *p)
{
    ...
    *first = 0;
    ...
    return tecmo_asset_pack_append_text(
        ...
        "\"freeze\":\"non-live phases, free throws, and TGDK black/cutaway frames preserve camera state; first live-return update resumes follow\","
        ...
        "\"projection\":\"TGCP projects actors and ball; jump altitude is applied exactly once to the actor and never added to the ball\","
