...
try {
    ...
    Assert-SeedBytes 6 0x8000 0x85FA "AE 08 03 AC 5A 03 B9 51 86 95 73 B9 57 86 95 E8 A9 94 95 F3 A9 7C 9D 47 05 A9 01 9D 51 05 AC 0A 03 A9 00 85 A4 B9 4F 86 85 A5 A6 A5 EC 08 03 F0 1E AD 0A 03 0A 65 A4 A8 B9 53 86 95 73 B9 59 86 95 E8 B9 5D 86 95 F3 E6 A4 A5 A4 C9 02 F0 05 C6 A5 4C 24 86 60" "Bank06 85EA post-call stores"
    Assert-SeedBytes 6 0x8000 0x86D2 "CC 08 03 F0 0C AE 08 03 8C 08 03 20 B0 88 AC 08 03 AE 0A 03 98 95 0E DD 7F 03 D0 14 C8 C0 05 D0 05 A0 00 4C FE 86 C0 0A D0 02 A0 05 98 9D 7F 03 AC 08 03 A9 04 99 7C 05 A9 68 99 47 05 A9 01 99 51 05 A9 02 8D 87 05 20 28 87 AE 0A 03 A5 A4 9D 7F 03 8D DA 06 60" "Bank06 86D2 full tail"
    Assert-SeedBytes 6 0x8000 0x8728 "A0 03 A2 09 A9 00 85 16 EC 08 03 F0 3B BD B0 04 29 10 D0 34 C0 02 90 06 20 74 87 4C 68 87 AD 87 05 C9 02 F0 0F B9 A8 87 9D 47 05 B9 AA 87 9D 51 05 4C 68 87 B9 A4 87 9D 47 05 B9 A6 87 9D 51 05 A9 04 9D 7C 05 88 86 A4 CA 10 BD 60" "Bank06 8728 descending scan"
    Assert-SeedBytes 6 0x8000 0x8774 "B5 F3 C9 96 90 15 A5 16 C9 01 F0 0F A9 3A 9D 47 05 A9 02 9D 51 05 A9 01 85 16 60 A5 16 C9 02 F0 EB A9 26 9D 47 05 A9 02 9D 51 05 A9 02 85 16 60" "Bank06 8774 stream choice"
    ...
    $ExpectedCpuOwnershipOverlayHashes = @{
        "gameplay-live-f3-overlay" =
            # The repaired human-game path remains LIVE while showing the
            # same exact first-period `$85EA` staging coordinates.
            "AF37CE3DA8C51492C0C262B1EC22ADFD274B765450D23B188C3721A2F28716DD"
        "gameplay-live-f3-auto-overlay" =
            # Exact first-period `$85EA` staging changes the automatic
            # holder/teammate placement visible in this ownership overlay.
            "B4F0E7309A11B4FB5D801C4913FB9C5DAFDD769EDD56C84BF9B5A86EF05438CC"
    }
    ...
    if ($RenderHashes["gameplay-facing-away-left"] -ne
            "48947A7FDA127267730DCDB1424CE9ED259AC2744ADA9F8BD37FB4291BA436C5") {
    ...
    $ExpectedBallBounceHashes = @{
        "gameplay-ball-bounce-frame1" =
            "9C90366C67E1F967C80687B1DDCD7D50269C94C48C33C8DC5A740FE9F9772E6A"
        "gameplay-ball-bounce-frame12" =
            "54C086920C7A9FB5B186E95003EA5F559548C64A91E1C767D4D12EE65A65F51D"
    }
    ...
    # These ordinary-LIVE checkpoints retain the exact first-period seed
    # placement; each golden therefore includes the `$85EA` actor layout.
    if ($RenderHashes["gameplay-cpu-steering-frame25"] -ne
            "D51AA7AB54CB50DC86CE574438FC368E28E6E30BB64A9ADE4AD0D0F2DC69B208") {
        throw "Gameplay live TGAI/TGMO movement render hash changed."
    }
    $ExpectedPossessionSliceHashes = @{
        "gameplay-possession-left" =
            "0E8917A50D6DDDFAFE265F9B004E15B22C79D7C0F1FA2117025B79790B6352F2"
        "gameplay-possession-center" =
            "E1634E4748D996E6A53BAE8BB6904C7D7A2E88E3359B80262EC75EF3A4B984AA"
        "gameplay-possession-right" =
            "CB0890F9C71B7D7073BDEB185F7947690F870912D9C63BFA1232A06078558DC0"
    }
    ...
    if ($RenderHashes["gameplay-uniform-pacers"] -ne
            "7281DB42B5C0B98A2EB7C0CFC95584CB953BCD9C349672470B5B16B90C3710D4" -or
    ...
    $ExpectedFreeThrowHashes = @{
        "gameplay-free-throw-left" =
            "D4F8473C61CD132FEBB30F8523F31AA7DB524E3718691C7F2EEB963158124DBE"
        "gameplay-free-throw-right" =
            "5007444D9FB1C8E2219425D50F5EC4BF58C37B80E863644505E69DCAD3F348D5"
    }
    ...
    $ExpectedJumpHashes = @{
        "gameplay-jump-frame1" =
            "854C46109E9A2243E367B0D2AB7C723319BB7C0781AC238671A7DEF52F159CD0"
        "gameplay-jump-frame2" =
            "BF11C294D0868CAB5A180393C9F834DEAB075650222BC828C71D017D78CAA85B"
        "gameplay-jump-frame4" =
            "B0C643E7C12B6E9FF1FAE4DCDC89EABB7E517D9EEFF0DB9943E6DD4CC53C5EFB"
        "gameplay-jump-frame75" =
            "D0FD43E9F1D40A14AFB41918564BDDEF20E9D22960C39CF9EBA5284C27E09C2A"
        "gameplay-jump-frame87" =
            "313C7A11E980E0BD7E8EB0FE001213E01B259B63620136CC664EF192036CDEC3"
    }
    ...
    $ExpectedRattleHashes = @{
        "gameplay-jump-rattle-frame72" =
            "A1C8E565A1371014322F66EF311BC8E15273B2880F2558AE2649D6D41C11BF4E"
        "gameplay-jump-rattle-frame73" =
            "1E92E22F246ADC503C72B923E5AB670F21E64903B904F55041004029C0839FB4"
        "gameplay-jump-rattle-frame74" =
            "DA044E37EE079253CE4380B6B46452C9E638962508EC72C53296871570D19671"
        "gameplay-jump-rattle-frame77" =
            "F719B4B4512C645E18EF01E58EFD905D58FCD5BB23B8A7A581BAF76354034FE9"
        ...
        "gameplay-jump-rattle-frame103" =
            "6A3CE3233F2A53C8A0049EF51405B9EE66FE53E539179E0B664FA4FB4BE9B8C3"
    }
    ...
    $ExpectedJumpMakeHashes = @{
        "gameplay-jump-make-frame9" =
            "2FB0583A0E876CD0B01910623B133EF7FA4E54B1794FB35520956E7EC533CE8F"
        "gameplay-jump-make-frame20" =
            "15B266BD9E285EC4FB16B4C04B74EFC97329172304411663BFE31487479464D6"
        "gameplay-jump-make-frame57" =
            "6F99183549C19EA0835E41D6F69C39EE64B5F153418A1A886C53311C1AF82690"
